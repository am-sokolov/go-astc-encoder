...
func TestDecodeRGBA8_MatchesNative_ForRepoFixtures(t *testing.T) {
	...
	fixtures := []fixture{
		{path: "../Test/Data/Tiles/ldr.astc", profile: astc.ProfileLDR},
		{path: "../Test/Data/LDR-A-1x1.astc", profile: astc.ProfileLDR},
		{path: "../Test/Data/LDRS-A-1x1.astc", profile: astc.ProfileLDRSRGB},
		// This file contains HDR constant blocks; LDR profile should decode to magenta error pixels.
		{path: "../Test/Data/Tiles/hdr.astc", profile: astc.ProfileLDR},
	}
...
func TestDecodeRGBAF32_MatchesNative_ForRepoFixtures(t *testing.T) {
	...
	fixtures := []fixture{
		{path: "../Test/Data/HDR-A-1x1.astc", profile: astc.ProfileHDRRGBLDRAlpha},
		{path: "../Test/Data/HDR-A-1x1.astc", profile: astc.ProfileHDR},
		{path: "../Test/Data/Tiles/hdr.astc", profile: astc.ProfileHDR},
	}
